...
function modChip(name, value) {
  ...
  if (!isNaN(num)) {
    ...
    const noMultiply = /^yearly_|^monthly_|republican_tradition|legitimacy|^stability$|horde_unity|devotion|meritocracy|^corruption$|inflation_reduction|interest$|liberty_desire|war_exhaustion_cost/.test(ln);
